...
func Default() *Client { return New(nil, nil) }

const (
	urlWHOCasesData       = "https://covid19.who.int/WHO-COVID-19-global-data.csv"
	urlTokyoPositivesData = "https://stopcovid19.metro.tokyo.lg.jp/data/130001_tokyo_covid19_patients.csv"
)
...
//TokyoPositivesData returns respons positives data of PCR test by Tokyo-Japan
func (c *Client) TokyoPositivesData() (io.ReadCloser, error) { return c.Get(urlTokyoPositivesData) }
